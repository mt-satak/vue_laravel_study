          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                this.loading = false; // 非同期通信が終わったらフラグを非表示に戻す
              ...
              case 10:
                this.reset();
                this.$emit('input', false); // NavbarのshowFormがfalseになりpropsを介してPhotoFormのvalueもfalseになる→非表示に
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(context, data) {
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              context.commit('setApiStatus', null); // 初期値はnullとする
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vuex__WEBPACK_IMPORTED_MODULE_1__["default"]); // auth.jsをモジュール登録してストアを作成する
...
var UNPROCESSABLE_ENTITY = 422; // バリデーションエラー時
...
__webpack_require__(/*! /Users/satak/laravel_docker/app/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/satak/laravel_docker/app/resources/sass/app.scss */"./resources/sass/app.scss");
